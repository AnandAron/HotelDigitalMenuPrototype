...
public class Gravies extends Fragment {
    private static final String TAG="Gravies";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_gravies, container, false);
        listView= (ListView) rootView.findViewById(R.id.gravies_list_view);
