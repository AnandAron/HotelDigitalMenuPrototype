...
public class RiceAndNoodles extends Fragment {
    private static final String TAG="Rice & Noodles";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView= (ListView) rootView.findViewById(R.id.rice_list_view);
