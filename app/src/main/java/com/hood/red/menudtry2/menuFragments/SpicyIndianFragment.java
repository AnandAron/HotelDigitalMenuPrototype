...
public class SpicyIndianFragment extends Fragment {
    private static final String TAG="Spicy Indian";
    private ListView listView;
    List<MenuItem> menuItemList;
    MenuAdapter menuAdapter;

    public SpicyIndianFragment() {
    }
    public static Fragment newInstance() {
        return new SpicyIndianFragment();
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_spicy_indian, container, false);
        listView= (ListView) rootView.findViewById(R.id.spicy_indian_list_view);
