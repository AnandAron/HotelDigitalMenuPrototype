...
public class Rolls extends Fragment {
    private static final String TAG="Rolls";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_rolls, container, false);
        listView= (ListView) rootView.findViewById(R.id.rolls_list_view);
